...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> callbackByMessage;
    ...
    public MicroService(String name) {
        this.name = name;
        callbackByMessage = new ConcurrentHashMap<>();
    }
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        Future eventFuture = MessageBusImpl.getInstance().sendEvent(e);
        return eventFuture;
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                callbackByMessage.get(message.getClass()).call(message);
